...
"}\n"
"#endif\n"
"#define INT4_2_UCHAR16(a, index) ""{ "" int index0 = yin * input_channel + xin + index; "" int index1 = (yin + 1) * input_channel + xin + index; "" int index2 = (yin + 2) * input_channel + xin + index; "" int index3 = (yin + 3) * input_channel + xin + index; "" int index4 = (yin + 4) * input_channel + xin + index; "" int index5 = (yin + 5) * input_channel + xin + index; "" int index6 = (yin + 6) * input_channel + xin + index; "" int index7 = (yin + 7) * input_channel + xin + index; "" uchar s0 = input_ptr[index0/2]; "" uchar s1 = input_ptr[index1/2]; "" uchar s2 = input_ptr[index2/2]; "" uchar s3 = input_ptr[index3/2]; "" uchar s4 = input_ptr[index4/2]; "" uchar s5 = input_ptr[index5/2]; "" uchar s6 = input_ptr[index6/2]; "" uchar s7 = input_ptr[index7/2]; "" a.s0 = ((index0 % 2) == 0 ? (s0 & 0xf0) : (s0 << 4)) | ((index1 % 2) == 0 ? (s1 >> 4) : (s1 & 0x0f)); "" a.s1 = ((index2 % 2) == 0 ? (s2 & 0xf0) : (s2 << 4)) | ((index3 % 2) == 0 ? (s3 >> 4) : (s3 & 0x0f)); "" a.s2 = ((index4 % 2) == 0 ? (s4 & 0xf0) : (s4 << 4)) | ((index5 % 2) == 0 ? (s5 >> 4) : (s5 & 0x0f)); "" a.s3 = ((index6 % 2) == 0 ? (s6 & 0xf0) : (s6 << 4)) | ((index7 % 2) == 0 ? (s7 >> 4) : (s7 & 0x0f)); ""} \n"
