...
mMaps.insert(std::make_pair("glsl_where_comp", std::make_pair(glsl_where_comp,glsl_where_comp_len)));
mMaps.insert(std::make_pair("glsl_where_USE_INT_comp", std::make_pair(glsl_where_USE_INT_comp,glsl_where_USE_INT_comp_len)));
mMaps.insert(std::make_pair("glsl_where_FP16_comp", std::make_pair(glsl_where_FP16_comp,glsl_where_FP16_comp_len)));
mMaps.insert(std::make_pair("glsl_where_USE_INT_FP16_comp", std::make_pair(glsl_where_USE_INT_FP16_comp,glsl_where_USE_INT_FP16_comp_len)));
